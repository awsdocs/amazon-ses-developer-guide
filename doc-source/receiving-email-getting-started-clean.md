...
If you no longer want to use Route 53 to register your domain, you can [delete the registration](http://docs.aws.amazon.com/Route53/latest/DeveloperGuide/domain-delete.html) or [transfer the domain to another registrar](http://docs.aws.amazon.com/Route53/latest/DeveloperGuide/domain-transfer-from-route-53.html)\.