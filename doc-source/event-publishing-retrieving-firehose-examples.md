# Examples of event data that Amazon SES publishes to Kinesis Data Firehose<a name="event-publishing-retrieving-firehose-examples"></a>
...
## Reject record<a name="event-publishing-retrieving-firehose-reject"></a>
